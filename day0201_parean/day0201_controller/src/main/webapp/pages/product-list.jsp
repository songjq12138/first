		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							总共${info.pages} 页，共${info.total} 条数据。 每页 <select class="form-control" id="pageSelect">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<li><a href="javascript:topage(${info.prePage})">上一页</a></li>
							<c:forEach begin="1" end="${info.pages}" var="i">
							<li><a href="javascript:topage(${i})">${i}</a></li>
							</c:forEach>
							<li><a href="javascript:topage(${info.nextPage})" aria-label="Next">下一页</a></li>
							<li><a href="javascript:topage(${info.pages})" aria-label="Next">尾页</a></li>
						</ul>
					</div>
	...
	<script type="text/javascript">
		$(function(){
			$("#pageSelect").change(function(){
				location.href="${pageContext.request.contextPath}/product/findAll.do?rows="+$("#pageSelect").val();
				
			});
			$("#pageSelect option[value='"+${info.pageSize}+"']").attr("selected",true);
		})				
	</script>
	<script type="text/javascript">
		function topage(page){
			location.href="${pageContext.request.contextPath}/product/findAll.do?rows="+$("#pageSelect").val()+"&page="+page+"";
		}
	</script>
</body>
